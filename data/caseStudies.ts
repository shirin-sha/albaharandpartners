...
export const caseStudySlides = [
  {
    ...
    description:
      "Supported customers with a structured cybersecurity rollout approach, improving endpoint visibility and strengthening operational readiness through partner-aligned implementation and support.",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    description:
      "Assisted organizations in improving asset inventory clarity and control by aligning stakeholder requirements, integration needs, and deployment best practices.",
  },
  {
    id: 12,
